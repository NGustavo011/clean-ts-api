...
import { type SaveSurveyResultRepository, type SaveSurveyResult, type SaveSurveyResultParams, type SurveyResultModel, type LoadSurveyResultRepository } from './db-save-survey-result-protocols'
